 ...
 *  In general, you can consider singleton patterns to implement a centralized
 *  management system, to mantain a common log file, to mantain thread pools
 *  in a multithreaded environment, to implement catching mechanism or
 *  device drivers, an so forth.
 */
